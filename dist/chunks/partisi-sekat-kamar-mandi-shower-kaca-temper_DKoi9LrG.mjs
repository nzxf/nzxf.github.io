...
const html = "<h2 id=\"deskripsi\">Deskripsi</h2>\n<ul>\n<li>Kaca Temper 10mm</li>\n<li>Aksesoris Stainless Steel / Atau Aluminium</li>\n<li>Sealant Anti Bocor</li>\n</ul>\n<h2 id=\"tambahan\">Tambahan</h2>\n<ul>\n<li>Jika mempunyai desain atau preferensi model sendiri, silahkan dikonsultasikan ke kami.</li>\n</ul>";
				...
				const frontmatter = {"publishDate":"2023-01-26T00:00:00.000Z","author":"Zan","code":"pt001","title":"Partisi Kaca Temper Kamar Mandi Shower","price":2125000,"priceBefore":2500000,"priceTail":"/m²","image":"~/assets/images/produk/partisi/partisiTemperShower.png","category":"Partisi","tags":["kaca","kaca temper","kamar mandi","interior","stainless steel"],"metadata":{"canonical":"https://mitrabangunkreasi.com/p/jj003"},"readingTime":1};
				const file = "/home/zan/Code/nzxf.github.io/src/content/post/partisi/partisi-sekat-kamar-mandi-shower-kaca-temper.md";
				const url = undefined;
				function rawContent() {
