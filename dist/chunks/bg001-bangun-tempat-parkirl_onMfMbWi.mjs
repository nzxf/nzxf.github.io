...
const html = "<h2 id=\"pilihan-besi-baja-struktural\">Pilihan Besi Baja Struktural</h2>\n<p>Jenis besi baja struktural yang bisa dipilih untuk digunakan sebagai keperluan struktural dan konstruksi gudang industri.</p>\n<ol>\n<li>Wide Flange (WF)</li>\n<li>U Channel atau Kanal U/UNP</li>\n<li>C Channel (Kanal C, CNP)</li>\n<li>Besi Hollow Besar / Rectangular Hollow Section</li>\n<li>Pipa Besi / Steel Pipe</li>\n</ol>";
				...
				const frontmatter = {"publishDate":"2023-07-22T00:00:00.000Z","author":"Zan","code":"bg001","title":"Bangun Tempat Parkir Semi Indoor","excerpt":"Usaha anda butuh ruang parkir yang luas?","image":"~/assets/images/konstruksi/bg001c.png","category":"Konstruksi","price":30000,"priceBefore":35000,"priceTail":"/kg","tags":["bangun","gudang","industri"],"metadata":{"canonical":"https://mitrabangunkreasi.com/p/bg001-bangun-gudang-industrial"},"readingTime":1};
				const file = "/home/zan/Code/nzxf.github.io/src/content/post/konstruksi/bg001-bangun-tempat-parkirl.md";
				const url = undefined;
				function rawContent() {
