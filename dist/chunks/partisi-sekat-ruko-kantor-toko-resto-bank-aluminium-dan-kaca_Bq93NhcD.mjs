...
const html = "<h2 id=\"deskripsi\">Deskripsi</h2>\n<ul>\n<li>Kaca Temper 10mm</li>\n<li>Aksesoris Stainless Steel / Atau Aluminium</li>\n<li>Sealant Anti Bocor</li>\n</ul>\n<h2 id=\"tambahan\">Tambahan</h2>\n<ul>\n<li>Jika mempunyai desain atau preferensi model sendiri, silahkan dikonsultasikan ke kami.</li>\n</ul>";
				...
				const frontmatter = {"publishDate":"2023-01-25T00:00:00.000Z","author":"Zan","code":"pt003","title":"Partisi Sekat Kantor Toko Resto Bank Kaca Temper","price":350000,"priceBefore":400000,"priceTail":"/m²","image":"~/assets/images/produk/partisi/partisiAlumKaca.png","category":"Partisi","tags":["kaca","aluminium","alumunium","kantor","toko","ruko","resto","bank"],"metadata":{"canonical":"https://mitrabangunkreasi.com/p/jj003"},"readingTime":1};
				const file = "/home/zan/Code/nzxf.github.io/src/content/post/partisi/partisi-sekat-ruko-kantor-toko-resto-bank-aluminium-dan-kaca.md";
				const url = undefined;
				function rawContent() {
