...
import { $ as $$Hero } from '../chunks/Hero_BYrLz7O_.mjs';
import { $ as $$Features2 } from '../chunks/Features2_C02ynB8f.mjs';
import { $ as $$Steps } from '../chunks/Steps_plXJSQbu.mjs';
import { $ as $$BlogLatestPosts } from '../chunks/BlogLatestPosts_CFmL-ifc.mjs';
import { $ as $$Stats } from '../chunks/Stats_BJ8MGHa3.mjs';
import { $ as $$Testimonials } from '../chunks/Testimonials_LrWo5dGB.mjs';
import { $ as $$Brands } from '../chunks/Brands_0g4gQBfp.mjs';
import { $ as $$CallToAction } from '../chunks/CallToAction_BcIpfXA_.mjs';
import product1 from '../chunks/product1_ZvGN8Iqp.mjs';
...
import gudang from '../chunks/bg001a_PAFw4QJD.mjs';
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`   ${renderComponent($$result2, "Hero", $$Hero, { "actions": [
    {
      ...
      href: `https://wa.me/6285176712656?text=MBK,%20saya%20mau%20survey%20...`,
      target: "_blank",
...
Konstruksi Rumah Yang Berkualitas, ${maybeRenderHead()}<span class="text-red-600 highlight"> Renovasi Yang Berkelas. </span> ` })}` })}    ${renderComponent($$result2, "Catalog", $$Catalog, { "title": "Katalog Produk & Jasa Unggulan MBK", "subtitle": "Harga Miring Kualitas Bersaing", "tagline": "", "prices": [
    {
      title: "Konstruksi Beton",
      image: {
        src: gudang,
    ...
    },
    {
      ...
      callToAction: {
        target: "_blank",
        text: "Lihat Katalog Pagar Besi",
        href: "/kategori/pagar"
      }
    },
    {
      title: "Partisi/Sekat Dinding",
      image: {
        src: product1,
