...
import { d as getStaticPathsBlogList, e as blogListRobots } from '../../chunks/blog_iHAGWjLZ.mjs';
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="px-6 sm:px-6 py-12 sm:py-16 lg:py-10 mx-auto max-w-4xl"> ${renderComponent($$result2, "Headline", $$Headline, { "subtitle": "Semua tulisan dan produk yang tersedia, diurutkan berdasarkan yang paling baru." }, { "default": ($$result3) => renderTemplate`
Semua
` })} ${renderComponent($$result2, "BlogList", $$List, { "posts": page.data })} ${renderComponent($$result2, "Pagination", $$Pagination, { "prevUrl": page.url.prev, "nextUrl": page.url.next })} <!--
    ...
    --> </section> ` })}`;
}, "/home/zan/Code/nzxf.github.io/src/pages/[...blog]/[...page].astro", void 0);

const $$file = "/home/zan/Code/nzxf.github.io/src/pages/[...blog]/[...page].astro";
const $$url = "/[...blog]/[...page]";
