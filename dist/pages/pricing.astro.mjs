...
import { $ as $$HeroText } from '../chunks/HeroText_lYTeuYZ4.mjs';
...
import { $ as $$FAQs } from '../chunks/FAQs_DXhp4h0h.mjs';
import { $ as $$Steps } from '../chunks/Steps_plXJSQbu.mjs';
import { $ as $$Features3 } from '../chunks/Features3_B2Qn6_D4.mjs';
...
const $$Pricing$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "WidgetWrapper", $$WidgetWrapper, { "id": id, "isDark": isDark, "containerClass": `max-w-7xl mx-auto ${classes?.container ?? ""}`, "bg": bg }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Headline", $$Headline, { "title": title, "subtitle": subtitle, "tagline": tagline })} ${maybeRenderHead()}<div class="flex items-stretch justify-center"> <div class="grid grid-cols-2 gap-4 dark:text-white sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3"> ${prices && prices.map(({ title: title2, image, subtitle: subtitle2, price, period, items, callToAction, hasRibbon = false, ribbonTitle }) => renderTemplate`<div class="justify-center col-span-3 mx-auto flex w-full sm:col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-1 intersect-once motion-safe:md:intersect:animate-fade motion-safe:md:opacity-0 intersect-quarter"> ${price && period && renderTemplate`<div class="rounded-lg backdrop-blur border border-gray-100 dark:border-gray-900 bg-white dark:bg-slate-900 shadow px-6 py-8 flex w-full max-w-sm flex-col justify-between text-center"> ${hasRibbon && ribbonTitle && renderTemplate`<div class="absolute right-[-5px] 2xl:right-[-8px] rtl:right-auto rtl:left-[-8px] rtl:2xl:left-[-10px] top-[-5px] 2xl:top-[-10px] z-[1] h-[100px] w-[100px] overflow-hidden text-right"> <span class="absolute top-[19px] right-[-21px] rtl:right-auto rtl:left-[-21px] block w-full rotate-45 rtl:-rotate-45 bg-green-700 text-center text-[10px] font-bold uppercase leading-5 text-white shadow-[0_3px_10px_-5px_rgba(0,0,0,0.3)] before:absolute before:left-0 before:top-full before:z-[-1] before:border-[3px] before:border-r-transparent before:border-b-transparent before:border-l-green-800 before:border-t-green-800 before:content-[''] after:absolute after:right-0 after:top-full after:z-[-1] after:border-[3px] after:border-l-transparent after:border-b-transparent after:border-r-green-800 after:border-t-green-800 after:content-['']"> ${ribbonTitle} </span> </div>`} <div class="px-2 py-0"> ${title2 && renderTemplate`<h3 class="text-center text-2xl font-extrabold uppercase leading-9 mb-6">${title2}</h3>`} ${image && renderTemplate`<div class="flex justify-center my-5 rounded-md">  ${renderComponent($$result2, "Image", $$Image, { "src": image.src, "alt": image.alt || "", "class": " max-w-full mx-auto mb-6 sm:rounded-md bg-gray-400 dark:bg-slate-700", "widths": [400, 900], "sizes": "(max-width: 900px) 400px, 900px", "width": 400, "height": 900, "loading": "eager", "decoding": "async", "format": "webp" })} </div>`} ${subtitle2 && renderTemplate`<span class="font-light sm:text-small text-black-400 dark:text-slate-400">${subtitle2}</span>`} <div> <div class="flex items-center justify-center text-center mb-1"> <span class="text 4xl">Rp</span> <span class="text-4xl font-bold">${price}</span> <span class="text 4xl">${period}</span> </div> </div> ${items && renderTemplate`<ul class="my-8 md:my-10 space-y-2 text-left"> ${items.map(
  ...
  )} </ul>`} </div> ${callToAction && renderTemplate`<div${addAttribute(`flex justify-center my-2`, "class")}> ${typeof callToAction === "string" ? renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate`${unescapeHTML(callToAction)}` })}` : callToAction && callToAction.href && renderTemplate`${renderComponent($$result2, "Button", $$Button, { ...hasRibbon ? { variant: "primary" } : {}, ...callToAction })}`} </div>`} </div>`} </div>`)} </div> </div> ` })}`;
}, "/home/zan/Code/nzxf.github.io/src/components/widgets/Pricing.astro", void 0);
...
}, "/home/zan/Code/nzxf.github.io/src/pages/pricing.astro", void 0);

const $$file = "/home/zan/Code/nzxf.github.io/src/pages/pricing.astro";
const $$url = "/pricing";
